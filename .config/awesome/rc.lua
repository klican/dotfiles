...
-- Register widget
vicious.register(pkgwidget, vicious.widgets.pkg, "($1)", 40, "Arch S")
...
for _, w in pairs(fs) do
  ...
  w.widget:buttons(awful.util.table.join(
    awful.button({ }, 1, function () exec("urxvtc -e ranger", false) end)
  ))
end -- Enable caching
vicious.cache(vicious.widgets.fs)
-- Register widgets
vicious.register(fs.s, vicious.widgets.fs, "${/boot used_p}", 59)
vicious.register(fs.r, vicious.widgets.fs, "${/ used_p}",     59)
vicious.register(fs.h, vicious.widgets.fs, "${/var used_p}", 59)
vicious.register(fs.b, vicious.widgets.fs, "${/home used_p}", 59)
-- }}}
...
globalkeys = awful.util.table.join(
    -- {{{ Applications
    --
    --This is a bugfix --workaround to fix problem, when firefox plugins (like
    --Flash, Acrobat and so on) are stealing the keyboard focus. Source:
...
--      properties = { tag = tags[1][2] } },
    ...
    { rule = { instance = "stardict" },
      properties = { floating = false } },
    { rule = { instance = "plugin-container" },
      properties = { floating = true }, callback = awful.titlebar.add  },
    { rule = { class = "Akregator" },   properties = { tag = tags[scount][8]}},
--  { rule = { class = "Zathura" },     properties = { tag = tags[1][4]} },
    { rule = { class = "Ark" },         properties = { floating = true } },
    { rule = { name = "galculator" },   properties = { floating = true }, callback = awful.placement.centered },
    { rule = { name = "stjerm" },       properties = { floating = true } },
    { rule = { name = "bashrun2" },     properties = { floating = true } },
--    { rule = { name = "sxiv" },         callback = awful.titlebar.add },
    { rule = { class = "Xfce4-notifyd" }, callback = awful.titlebar.add },
    { rule = { name = "Xfce4-notifyd" }, callback = awful.titlebar.add },
    { rule = { class = "Geeqie" },      properties = { floating = true } },
    { rule = { class = "ROX-Filer" },   properties = { floating = true } },
    { rule = { class = "Pinentry.*" },  properties = { floating = true } },
   
    
 -- this is for preventing apps to start maximized, e.g. to prevent weird behavior of firefox
