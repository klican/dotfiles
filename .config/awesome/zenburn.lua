...
theme.wallpaper_cmd = { "/usr/bin/nitrogen --restore" } -- moved from .xinitrc
--theme.wallpaper_cmd = { "awsetbg /usr/share/awesome/themes/zenburn/zenburn-background.png" }
--theme.wallpaper_cmd = { "awsetbg ~/pictures/archlinux-zenburn-wide.jpg" }
-- }}}
